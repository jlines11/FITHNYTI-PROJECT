                                    ...
                                    <?php foreach ($listereclamations as $reclamation) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php
                                                if($reclamation['traite']==1){
                                                ?>
                                                    <a href="archiverreclamation.php?id=<?= $reclamation['idrec']; ?>" class="btn btn-info">Archive Reclamation</a>

                                                    <label  class="label-on-right">Reclamation Traité</label>

                                                    <?php
                                                }
                                                else{
                                            ?>                                                 <a href="ajouterreponse.php?id=<?= $reclamation['idrec']; ?>" class="btn btn-info">Ajouter Reponse</a>
