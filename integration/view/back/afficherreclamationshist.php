...
$listereclamations = $reclamationc->affichereclamationshist();
?>
<!DOCTYPE html>
<html lang="en">
<head>
                                    ...
                                    <?php foreach ($listereclamations as $reclamation) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="dearchiverreclamation.php?id=<?= $reclamation['idrec']; ?>" class="btn btn-info">UnArchive Reclamation</a>
